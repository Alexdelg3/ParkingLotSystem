...
HD_PWD='C:/Users/alexd/OneDrive/2023 Uni Stuff/Embedded Computing Systems/Project Files/FinalFinalProject/FinalFinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Car_Parking_System_VHDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Car_Parking_System_VHDL.tcl -notrace
