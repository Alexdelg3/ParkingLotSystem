...
HD_PWD='C:/Users/alexd/OneDrive/2023 Uni Stuff/Embedded Computing Systems/Project Files/FinalFinalProject/FinalFinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Car_Parking_System_VHDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Car_Parking_System_VHDL.tcl
